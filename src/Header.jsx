...
function Header(){
    ...
    <div className="overflow-hidden ">
        ...
        <div className="text-center text-white mt-20 relative">
            ...
            <Link to="/Projects"><li className="text-2xl font-bold absolute top-72 bg-black py-2 px-8 rounded-3xl shadow-lg shadow-gray-600 border-2 border-white sm:left-[1000px] " href="Projects">View All</li></Link>
